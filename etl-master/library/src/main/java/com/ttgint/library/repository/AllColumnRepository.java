...
@Transactional
@Repository
public interface AllColumnRepository extends JpaRepository<AllColumn, Long> {

    List<AllColumn> findAllByFlowIdAndIsActiveAndNeedRefreshAndIsGeneratedAndIsFailed(Long flowId,
                                                                                      Boolean isActive,
                                                                                      Boolean needRefresh,
                                                                                      Boolean isGenerated,
                                                                                      Boolean isFailed);
    ...
    @Query("update AllColumn a " +
            ...
            "a.isFailed = :isFailed " +
            "where a.id = :id ")
    void updateColumnStatusById(@Param("id") Long id,
    ...
    void updateColumnStatusBySchemaNameAndTableName(@Param("schemaName") String schemaName,
