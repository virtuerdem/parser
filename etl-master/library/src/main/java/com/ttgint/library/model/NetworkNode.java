...
public class NetworkNode implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "t_network_node_seq_id", sequenceName = "t_network_node_seq_id", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "t_network_node_seq_id")
    private Long id;
    private Long unitId;
