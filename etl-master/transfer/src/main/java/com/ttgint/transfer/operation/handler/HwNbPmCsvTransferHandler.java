...
@Slf4j
public class HwNbPmCsvTransferHandler extends TransferBaseHandler {

    private final List<String> items;

    public HwNbPmCsvTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* HwNbPmCsvTransferHandler filterFiles and setFileInfos");
        super.filterFiles();
