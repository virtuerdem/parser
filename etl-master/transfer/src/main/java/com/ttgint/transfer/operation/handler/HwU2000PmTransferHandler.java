...
@Slf4j
public class HwU2000PmTransferHandler extends TransferBaseHandler {

    private final List<String> items;

    public HwU2000PmTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* HwU2000PmTransferHandler filterFiles and setFileInfos");
        super.filterFiles();
