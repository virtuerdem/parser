...
@Slf4j
public class IgCsPmTransferHandler extends TransferBaseHandler {

    private final List<String> nodes;

    public IgCsPmTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* IgCsPmTransferHandler filterFiles");
        super.filterFiles();
