...
@Slf4j
public class HwCsPmTransferHandler extends TransferBaseHandler {

    private final List<String> nodes;

    public HwCsPmTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* HwCsPmTransferHandler filterFiles and setFileInfos");
        super.filterFiles();
    ...
    public String getNodeName(String fileName) {
        return fileName.split("_", 2)[1].split(".xml")[0];
    }
}
