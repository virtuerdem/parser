...
@Slf4j
public class HwMwReportPmTransferHandler extends TransferBaseHandler {

    private final List<String> items;

    public HwMwReportPmTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* HwMwReportPmTransferHandler filterFiles and setFileInfos");
        super.filterFiles();
