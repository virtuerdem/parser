...
@Slf4j
public class HwEnbConfTransferHandler extends TransferBaseHandler {

    private final List<String> nodes;

    public HwEnbConfTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* HwEnbConfTransferHandler filterFiles and setFileInfos");
        super.filterFiles();
        getRemoteFiles().stream()
                .filter(e -> e.getFileName().startsWith("GExport_SR")
