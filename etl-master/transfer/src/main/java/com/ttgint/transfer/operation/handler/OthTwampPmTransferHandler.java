...
@Slf4j
public class OthTwampPmTransferHandler extends TransferBaseHandler {

    private final List<String> items;

    public OthTwampPmTransferHandler(ApplicationContext applicationContext,
    ...
    public void filterFiles() {
        log.info("* OthTwampPmTransferHandler filterFiles and setFileInfos");
        super.filterFiles();
    ...
    public OffsetDateTime getDate(String fileName) {
        return OffsetDateTime.parse(
                ...
                DateTimeFormatter.ofPattern("yyyyMMdd'T'HHmmXXX")
