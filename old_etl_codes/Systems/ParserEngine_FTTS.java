...
import com.ttgint.parserEngine.Northi.Vodafone.Parsers.FTTSCsvParser;
 ...
 */
@ParserSystem(systemType = "FTTS", measType = "CM", operatorName = "VODAFONE")
public class ParserEngine_FTTS extends AbsParserEngine {

    public static ArrayList<String> tableList = new ArrayList<>();

    public ParserEngine_FTTS(ParserSystem parserSystem) throws SQLException, InterruptedException, Exception {
        super(parserSystem);
    }
    ...
    public void prepareParser() {
        ...
        for (File eachFile : fileList) {
            if (eachFile.getName().endsWith(".csv")) {
                executorForParser.execute(new FTTSCsvParser(eachFile, OperationSystemEnum.WINDOWS, ProgressTypeEnum.PRODUCT));
            }
        }
